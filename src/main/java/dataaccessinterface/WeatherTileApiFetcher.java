...
public interface WeatherTileApiFetcher {
    ...
    /** Make an API call to <a href="https://weathermaps.weatherapi.
     * com">WeatherMaps</a> API to request
     ...
     * @throws TileNotFoundException If image data for <code>tile</code>
     * could not be parsed, or if the tile given is invalid.
     */
    BufferedImage getWeatherTileImageData(WeatherTile tile)
            throws TileNotFoundException;

    /** Make an API call to <a href="https://weathermaps.weatherapi.com">
     * WeatherMaps</a> API to request image data, and return a list of the
     * image data for all the {@link WeatherTile} in the list,
     ...
     * @return the list of image data associated with <code>tile</code> given
